...
export default function Header() {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 bg-background/98 lg:bg-background/60 lg:backdrop-blur-xl border-b border-white/5 transition-colors duration-300"
      dir="ltr"
    >
