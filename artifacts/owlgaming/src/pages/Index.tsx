        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 z-10 text-left">
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-8">
                {[
                  ...
                  <div
                    key={label}
                    className="relative rounded-2xl p-2.5 sm:p-4 border border-white/7 overflow-hidden text-left"
                  ...
                  >
                    ...
                    />
                    <p className="text-xl sm:text-2xl md:text-3xl font-black text-foreground font-nums relative z-10">{value}</p>
                    <p className="text-[10px] sm:text-xs text-foreground/50 mt-1 relative z-10" dir="auto">{label}</p>
                  </div>
                ))}
              </div>
            </div>
